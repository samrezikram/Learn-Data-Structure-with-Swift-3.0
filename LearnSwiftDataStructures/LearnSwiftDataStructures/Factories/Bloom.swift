...
class Bloom<T> {
    ...
    */
    ...
    func addElement(item: T) -> Bool {
        ...
        position.first = hash(element: item)!
        position.second = hash(element: position.first)!
        position.third = hash(element: position.second)!
    ...
    func contains(element: T) -> Bool {
        ...
        //establish "spread"
        position.first = hash(element: element)!
        position.second = hash(element: position.first)!
        position.third = hash(element: position.second)!
